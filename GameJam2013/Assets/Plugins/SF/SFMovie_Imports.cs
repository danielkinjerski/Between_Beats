...
public partial class  Movie: System.Object
{
    ...
    private static extern void SF_Advance(long movieID, float deltaTime, bool advanceWhilePaused = false);
    ...
    [DllImport("libgfxunity3d")]
    private static extern bool SF_HandleMouseEvent(long movieID, float x, float y, int icase);
    
    [DllImport("libgfxunity3d")]
    private static extern bool SF_HandleTouchEvent(long movieID, int fid, float x, float y, int icase);
    
    [DllImport("libgfxunity3d")]
    private static extern bool SF_DoHitTest(long movieID, float x, float y);
